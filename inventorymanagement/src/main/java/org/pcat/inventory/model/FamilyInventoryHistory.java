...
public class FamilyInventoryHistory implements FamilyInventory {
	...
	public FamilyInventoryHistory() {
		super();
		this.familyInventory = new FamilyInventoryImpl();
	}

	public FamilyInventoryHistory(Integer id, String familyId, Integer requestorId, String status,
